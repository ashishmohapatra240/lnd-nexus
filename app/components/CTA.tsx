            ...
            <div className="md:flex items-stretch">
              <div className="md:w-2/3 p-10 lg:p-14 text-white">
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Button 
                    size="lg" 
                    className="bg-white hover:bg-blue-50 text-blue-900 font-semibold shadow-lg hover:shadow-xl border-none transition-all duration-300 hover:-translate-y-0.5 w-full sm:w-auto"
                    asChild
                  >
                    <Link href="/register">
                      Create Account
                  ...
                  <Button 
                    size="lg" 
                    variant="outline" 
                    className="border-2 border-blue-400 bg-transparent text-white hover:bg-white/10 font-semibold transition-all duration-300 w-full sm:w-auto"
                    asChild
                  >
